...
&lt;!-- iosSlider plugin --&gt;
&lt;script type = 'text/javascript' src = '/iosSlider/jquery.iosslider-vertical.js'&gt;&lt;/script&gt;
</pre>
...
/* slide */
.iosslider-vertical .slider .slide {
	/* required */
	float: left;
...
$('.iosslider-vertical').iosslider-vertical('data', {
	obj,
	settings,
	scrollerNode,
	numberOfSlides,
...
$('.iosslider-vertical').iosslider-vertical('args', {
	sliderObject,
	sliderContainerObject,
	targetSlideObject,
	targetSlideNumber,
...
<table class="api">
	...
	<tbody>
		<tr>
			<td>$('div').iosslider-vertical('destroy');</td>
		...
		<tr>
			<td>$('div').iosslider-vertical('addSlide', slideHTML, slidePosition);</td>
